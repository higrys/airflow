...
|:--------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------|
| [operators.email.EmailOperator](https://github.com/apache/airflow/blob/master/airflow/providers/email/operators/email.py) | [airflow.operators.email_operator.EmailOperator](https://github.com/apache/airflow/blob/v1-10-stable/airflow/operators/email_operator.py) |
