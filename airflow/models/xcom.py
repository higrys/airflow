...
class XCom(Base, LoggingMixin):
    ...
    key = Column(String(512, **get_id_collation_args()), primary_key=True)
    ...
    # source information
    task_id = Column(String(ID_LEN, **get_id_collation_args()), primary_key=True)
    dag_id = Column(String(ID_LEN, **get_id_collation_args()), primary_key=True)
