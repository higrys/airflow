...
def upgrade():
    ...
    if 'log' not in tables:
        op.create_table(
            ...
            sa.Column('dag_id', sa.String(length=250, **get_id_collation_args()), nullable=True),
            sa.Column('task_id', sa.String(length=250, **get_id_collation_args()), nullable=True),
    ...
    if 'sla_miss' not in tables:
        op.create_table(
            'sla_miss',
            sa.Column('task_id', sa.String(length=250, **get_id_collation_args()), nullable=False),
            sa.Column('dag_id', sa.String(length=250, **get_id_collation_args()), nullable=False),
    ...
    if 'xcom' not in tables:
        op.create_table(
            'xcom',
            sa.Column('id', sa.Integer(), nullable=False),
            sa.Column('key', sa.String(length=512, **get_id_collation_args()), nullable=True),
