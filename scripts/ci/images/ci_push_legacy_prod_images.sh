...
legacy_python_base_image="ghcr.io/${GITHUB_REPOSITORY}-${BRANCH_NAME}-python${PYTHON_MAJOR_MINOR_VERSION}-v2:${GITHUB_REGISTRY_PUSH_IMAGE_TAG}"
docker tag "${AIRFLOW_PYTHON_BASE_IMAGE}" "${legacy_python_base_image}"
docker push "${legacy_python_base_image}"
